...
class DataArgs:
    ...
    exp_desc = "demo"
    dataset_dir_prefix:str = '../iwslt_2014_bt/'
    dataset_path:str = 'jrc_joint/ende'
    train_file:str = 'train.json'
    dev_file:str = 'dev.json'
    test_file:str = 'test.json'
    tm_size = 5
    tm_path = '../iwslt_2014_bt/retrieval/ende/src_editdis_alpha_0.7bt_rbt.pkl'
...
class TrainingArgs(TrainingArguments):
    ...
    output_dir: str = '../results_0721/jrc/ende/dual'
    ...
    num_train_epochs: float = 80
    max_steps:int = 160000
    per_device_train_batch_size: int = 6500 # tokens
    per_device_eval_batch_size: int = 10  # sentences
    #eval_accumulation_steps
    gradient_accumulation_steps: int = 1 #because the batch size is 8000 it will be better to set it 2
